...
public class SubinterestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subinterest);
        ...
        telp.setOnClickListener(new View.OnClickListener() {
            ...
            private void goToTelp() {
                ...
                intent.setData(Uri.parse("tel:089972991889"));
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            private void goToBack() {
                Intent intent = new Intent(SubinterestActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
